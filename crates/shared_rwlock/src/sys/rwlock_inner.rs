...
use super::windows::futex::{Futex, Primitive, futex_wait, futex_wake, futex_wake_all};
use core::sync::atomic::Ordering::{Acquire, Relaxed, Release};

/// It exists in the SharedMemory situation and atomically edits the data involved in the lock.
///
/// No `Self::new` to create by `core::mem::transmute` SharedMemory.
///
/// # Safety
...
pub struct RwLock {
    ...
    _reserved8: u64,  // 0x8
    _reserved10: u64, // 0x10
    _reserved18: u64, // 0x18
    _reserved20: u64, // 0x20
    _reserved28: u64, // 0x28
    _reserved30: u64, // 0x30
...
#[inline]
const fn is_unlocked(state: Primitive) -> bool {
    state & MASK == 0
}

#[inline]
const fn is_write_locked(state: Primitive) -> bool {
    state & MASK == WRITE_LOCKED
}

#[inline]
const fn has_readers_waiting(state: Primitive) -> bool {
    state & READERS_WAITING != 0
}

#[inline]
const fn has_writers_waiting(state: Primitive) -> bool {
    state & WRITERS_WAITING != 0
}

#[inline]
const fn is_read_lockable(state: Primitive) -> bool {
...
#[inline]
const fn is_read_lockable_after_wakeup(state: Primitive) -> bool {
...
#[inline]
const fn has_reached_max_readers(state: Primitive) -> bool {
    state & MASK == MAX_READERS
}
